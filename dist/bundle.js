...
const Event = (() => {
  ...
  const { set, get, setClear } = (0,_Storage__WEBPACK_IMPORTED_MODULE_1__["default"])();
  const { SubmitProject, loadProject } = (0,_Project__WEBPACK_IMPORTED_MODULE_2__["default"])();
  const { filterTask, ProjectTask } = (0,_Task__WEBPACK_IMPORTED_MODULE_3__["default"])();
  let activeProject;
...
const Task = () => {
  const { get, setClear } = (0,_Storage__WEBPACK_IMPORTED_MODULE_0__["default"])();
  ...
  const filterTask = (key, date) => {
    ...
    Array.from(tasks).forEach((task) => {
      ...
      if (date === 'today') {
        if ((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(due)) loadTask(task, key, null);
      }
      if (date === 'thisweek') {
        if ((0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(due)) loadTask(task, key, null);
      }
      if (date === 'all') {
