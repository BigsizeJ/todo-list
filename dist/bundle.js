...
const Event = (() => {
  ...
  const { set } = (0,_Storage__WEBPACK_IMPORTED_MODULE_1__["default"])();
  const { SubmitProject, loadProject } = (0,_Project__WEBPACK_IMPORTED_MODULE_2__["default"])();
  const { filterTask } = (0,_Task__WEBPACK_IMPORTED_MODULE_3__["default"])();
    ...
    submit.addEventListener('click', (e) => {
      ...
      if (form.checkValidity() === false) {
        ...
        object = {
          ...
          dueDate: (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(due.value), 'MM-dd-yyyy'),
...
const Project = () => {
  const { set, get } = (0,_Storage__WEBPACK_IMPORTED_MODULE_0__["default"])();
...
const Task = () => {
  const { get } = (0,_Storage__WEBPACK_IMPORTED_MODULE_0__["default"])();
  ...
  const filterTask = (key, date) => {
    ...
    Array.from(tasks).forEach((task) => {
      ...
      const due = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(`${arr[2]}-${arr[0]}-${arr[1]}`);
      if (date === 'today') {
        if ((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(due)) loadTask(task);
      }
      if (date === 'thisweek') {
        if ((0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(due)) loadTask(task);
      }
      if (date === 'all') {
        loadTask(task);
      }
